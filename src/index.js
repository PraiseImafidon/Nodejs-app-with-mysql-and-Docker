...
app.get('/', (req, res) =>
    res.send(new Message(200, "Ok", "Patient's schedule", { patient: { name: "Opossum",
                                                            schedule: "March 10th, 2023" }})));

//console.log(process.env);

const PORT = process.env.PORT || 5000;
app.listen(PORT, ()=> console.log(`The server is running on: ${ip.address()}:${PORT}...`));